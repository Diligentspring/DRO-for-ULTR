...
class Raw_data:
    ...
    def load_data_in_IPS_format(self, data_path=None, file_prefix=None, rank_cut=None):
        ...
        elif file_prefix =='test_top_down':
            feature_fin = open(data_path + 'test_top_down/test.feature')
        elif file_prefix =='test_down_top':
            feature_fin = open(data_path + 'test_down_top/test.feature')
        else:
            feature_fin = open(
                data_path +
                'train/train.feature')
        ...
        if file_prefix =='valid':
            ...
            init_list_fin = open(data_path + 'test_top_down/test.init_list')
        elif file_prefix =='test_down_top':
            init_list_fin = open(data_path + 'test_down_top/test.init_list')
        else:
            init_list_fin = open(
                data_path +
        ...
        if file_prefix =='valid':
            ...
            label_fin = open(data_path + 'test_top_down/test.labels')
        elif file_prefix =='test_down_top':
            label_fin = open(data_path + 'test_down_top/test.labels')
        else:
            label_fin = open(
                data_path +
                'train' +
