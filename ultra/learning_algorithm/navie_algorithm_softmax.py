...
class NavieAlgorithm_softmax(BaseAlgorithm):
    """The navie algorithm that directly trains ranking models with input labels.

    """

    def __init__(self, feature_size, exp_settings, forward_only=False):
        """Create the model.
        ...
        """
        print('Build NavieAlgorithm_softmax')
    ...
    def train(self, input_feed):
        ...
        # print('docid_inputs维度')
        # print(self.docid_inputs.shape)
