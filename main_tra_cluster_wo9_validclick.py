...
from ultra.learning_algorithm.DRO_cluster_regression_exam import DRO_cluster_regression_exam
from ultra.learning_algorithm.DRO_cluster_PBM_click_model_exam import DRO_cluster_pbm_click_model_exam
...
def train(exp_settings):
    ...
    model = DRO_cluster_regression_exam(feature_size, exp_settings)
    ...
    # model = DRO_cluster_pbm_click_model_exam(feature_size, exp_settings)
    ...
    #     centroids = pickle.load(f)
    # with open('/home/niuzechun/ULTRA_DRO/Kmeans/centroids_c40.txt', 'rb') as f:
    #     centroids = pickle.load(f)
    # with open('/home/niuzechun/ULTRA_DRO/Kmeans/centroids_c30.txt', 'rb') as f:
    #     centroids = pickle.load(f)
    # with open('/home/niuzechun/ULTRA_DRO/Kmeans/centroids_c20.txt', 'rb') as f:
    #     centroids = pickle.load(f)
    # with open('/home/niuzechun/ULTRA_DRO/Kmeans/centroids_c10.txt', 'rb') as f:
    #     centroids = pickle.load(f)
    with open('/home/niuzechun/ULTRA_DRO/Kmeans/centroids_c20.txt', 'rb') as f:
        centroids = pickle.load(f)
            ...
            if current_step == 7000:
                ...
                if hasattr(model, 'propensity_model'):
                    checkpoint_path_propensity = os.path.join(args.model_dir, "%s.ckpt_propensity" % \
                            str(exp_settings['learning_algorithm']) + str(model.global_step))
                    torch.save(model.propensity_model.state_dict(), checkpoint_path_propensity)
                else:
                    pass
