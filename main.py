...
from ultra.learning_algorithm.regression_EM_point import RegressionEM_point
from ultra.learning_algorithm.regression_EM_point_true import RegressionEM_point_true
from ultra.learning_algorithm.regression_EM_list import RegressionEM_list
from ultra.learning_algorithm.regression_EM_attrank_true import RegressionEM_attrank_true
from ultra.learning_algorithm.regression_EM_list_true import RegressionEM_list_true
from ultra.learning_algorithm.regression_EM_softmax import RegressionEM_softmax
from ultra.learning_algorithm.regression_EM_softmax_nodiv import RegressionEM_softmax_nodiv
from ultra.learning_algorithm.regression_EM_arp import RegressionEM_arp
from ultra.learning_algorithm.regression_EM_arp_true import RegressionEM_arp_true
from ultra.learning_algorithm.regression_EM_listmle import RegressionEM_listmle
from ultra.learning_algorithm.regression_EM_arp_allpair import RegressionEM_arp_allpair
from ultra.learning_algorithm.regression_EM_listmle_allpair import RegressionEM_listmle_allpair
from ultra.learning_algorithm.regression_EM_arp_true_allpair import RegressionEM_arp_true_allpair
from ultra.learning_algorithm.regression_EM_softmax_allpair import RegressionEM_softmax_allpair
from ultra.learning_algorithm.regression_EM_softmax_true_allpair import RegressionEM_softmax_true_allpair
...
from ultra.learning_algorithm.DRO_pbm_click_model_bm25_even_p0 import DRO_PBM_Click_Model_bm25_even_p0
from ultra.learning_algorithm.DRO_regression_EM_list_bm25_even_p0 import DRO_RegressionEM_list_bm25_even_p0
from ultra.learning_algorithm.DRO_regression_EM_arp_bm25_even_p0 import DRO_RegressionEM_arp_bm25_even_p0
from ultra.learning_algorithm.DRO_regression_EM_arp_allpair_bm25_even_p0 import DRO_RegressionEM_arp_allpair_bm25_even_p0
from ultra.learning_algorithm.DRO_regression_EM_softmax_bm25_even_p0 import DRO_RegressionEM_softmax_bm25_even_p0
from ultra.learning_algorithm.DRO_naive_list_bm25_even_p0 import DRO_Naive_List_bm25_even_p0
from ultra.learning_algorithm.DRO_regression_EM_listmle_bm25_even_p0 import DRO_RegressionEM_listmle_bm25_even_p0
from ultra.learning_algorithm.DRO_regression_EM_listmle_sigmoid_bm25_even_p0 import DRO_RegressionEM_listmle_sigmoid_bm25_even_p0
from ultra.learning_algorithm.DRO_naive_list_querylength import DRO_Naive_List_querylength
from ultra.learning_algorithm.DRO_pbm_click_model_querylength import DRO_PBM_Click_Model_querylength
from ultra.learning_algorithm.DRO_IPS_PBM_arp_bm25_even_p0 import DRO_IPS_PBM_arp_bm25_even_p0
from ultra.learning_algorithm.DRO_IPS_PBM_softmax_querylength import DRO_IPS_PBM_softmax_querylength
from ultra.learning_algorithm.DRO_IPS_PBM_groupsoftmax_bm25_even_p0 import DRO_IPS_PBM_groupsoftmax_bm25_even_p0
from ultra.learning_algorithm.DRO_IPS_PBM_grouparp_bm25_even_p0 import DRO_IPS_PBM_grouparp_bm25_even_p0
from ultra.learning_algorithm.DRO_IPS_PBM_grouparp_smooth_bm25_even_p0 import DRO_IPS_PBM_grouparp_smooth_bm25_even_p0
from ultra.learning_algorithm.DRO_naive_arp_bm25_even_p0 import DRO_Naive_arp_bm25_even_p0
from ultra.learning_algorithm.DRO_naive_arp_bm25_impre_p0 import DRO_Naive_arp_bm25_impre_p0
from ultra.learning_algorithm.DRO_naive_arp_bm25_impre_p0_eta import DRO_Naive_arp_bm25_impre_p0_eta

from ultra.learning_algorithm.DRO_naive_arp_bm25_click import DRO_Naive_arp_bm25_click
from ultra.learning_algorithm.DRO_naive_arp_bm25_click_p0 import DRO_Naive_arp_bm25_click_p0
from ultra.learning_algorithm.DRO_naive_arp_bm25_click_p0_wo9 import DRO_Naive_arp_bm25_click_p0_wo9
from ultra.learning_algorithm.DRO_naive_arp_bm25_click_p0_wo9_eta import DRO_Naive_arp_bm25_click_p0_wo9_eta
from ultra.learning_algorithm.DRO_naive_arp_bm25_click_p0_wo9_eta_g3 import DRO_Naive_arp_bm25_click_p0_wo9_eta_g3
from ultra.learning_algorithm.DRO_naive_arp_bm25_pos_click_p0_wo9_eta_g3 import DRO_Naive_arp_bm25_pos_click_p0_wo9_eta_g3
from ultra.learning_algorithm.DRO_naive_arp_bm25_pos_click_p0_wo9_eta_g3_allpair import DRO_Naive_arp_bm25_pos_click_p0_wo9_eta_g3_allpair
...
def get_batch_click(model, data_set, batch_size, list_size):
...
def train(exp_settings):
    ...
    # model = RegressionEM_point(feature_size, exp_settings)
    # model = RegressionEM_point_true(feature_size, exp_settings)
    # model = RegressionEM_list(feature_size, exp_settings)
    # model = RegressionEM_attrank_true(feature_size, exp_settings)
    # model = RegressionEM_list_true(feature_size, exp_settings)
    # model = RegressionEM_arp(feature_size, exp_settings)
    # model = RegressionEM_arp_true(feature_size, exp_settings)
    # model = RegressionEM_softmax(feature_size, exp_settings)
    # model = RegressionEM_softmax_nodiv(feature_size, exp_settings)
    # model = RegressionEM_listmle(feature_size, exp_settings)
    # model = RegressionEM_arp_allpair(feature_size, exp_settings)
    # model = RegressionEM_listmle_allpair(feature_size, exp_settings)
    # model = RegressionEM_arp_true_allpair(feature_size, exp_settings)
    # model = RegressionEM_softmax_allpair(feature_size, exp_settings)
    # model = RegressionEM_softmax_true_allpair(feature_size, exp_settings)
    # model = RegressionEM_point_true_allpair(feature_size, exp_settings)

    # model = DRO_PBM_Click_Model_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_PBM_Click_Model_querylength(feature_size, exp_settings)
    # model = DRO_RegressionEM_list_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_RegressionEM_arp_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_RegressionEM_arp_allpair_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_RegressionEM_softmax_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_Naive_List_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_RegressionEM_listmle_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_Naive_List_querylength(feature_size, exp_settings)
    # model = DRO_IPS_PBM_arp_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_IPS_PBM_softmax_querylength(feature_size, exp_settings)
    # model = DRO_IPS_PBM_groupsoftmax_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_IPS_PBM_grouparp_smooth_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_even_p0(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_impre_p0(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_impre_p0_eta(feature_size, exp_settings)

    # model = DRO_Naive_arp_bm25_click(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_click_p0(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_click_p0_wo9(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_click_p0_wo9_eta(feature_size, exp_settings)
    # model = DRO_Naive_arp_pos_click_p0_wo9_eta(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_click_p0_wo9_eta_g3(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_pos_click_p0_wo9_eta_g3(feature_size, exp_settings)
    # model = DRO_Naive_arp_bm25_pos_click_p0_wo9_eta_g3_allpair(feature_size, exp_settings)
    # model.print_info()
    ...
    while True:
        ...
        input_feed, info_map = get_batch_click(model, train_dataset, exp_settings['batch_size'], exp_settings['selection_bias_cutoff'])
        ...
        if current_step % args.steps_per_checkpoint == 0:
            ...
            if hasattr(model, 'propensity_model_logit'):
                ...
                propensity_file.write('current_step:'+str(current_step)+'\n')
                # propensity = torch.squeeze(model.propensity_model(), dim=0).cpu().detach().numpy()
                propensity = torch.squeeze(torch.softmax(model.propensity_model_logit(), dim=-1), dim=0).cpu().detach().numpy()
                for i in range(len(propensity)):
                    propensity_file.write(str(propensity[i])+' ')
                propensity_file.write('\n')
                propensity_file.close()
        ...
        #     # Validate model
            def validate_model(data_set):
                ...
                while it < len(data_set):
                    ...
                    input_feed, info_map = get_batch_annotation(it, model, data_set, exp_settings['batch_size'], exp_settings['max_candidate_num'])
        ...
        #
            ...
            if args.test_while_train:
                test_summary = validate_model(test_dataset)
